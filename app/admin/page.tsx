          ...
          <div className="flex flex-col justify-between gap-10 border-b border-white/10 pb-12 md:flex-row">
            ...
            <div className="grid grid-cols-2 gap-x-14 gap-y-8 text-sm text-white/50">
              <div>
                ...
                <p>{footerData?.contact?.phone || contactData?.phone || '+34 600 000 000'}</p>
                <p>{footerData?.contact?.email || contactData?.email || 'info@renovactiva.com'}</p>
              </div>
              <div>
                <p className="mb-3 text-[10px] uppercase tracking-[0.2em] text-[#d7bd77]">
                ...
                <p>
                  {ca
                    ? (footerTrans.address?.street || footerData?.address?.street || contactData?.address || 'Carrer Exemple 123')
                    : (footerData?.address?.street || contactData?.address || 'Carrer Exemple 123')}
                </p>
                {(footerData?.address?.postal || footerData?.address?.city) && (
                  <p>
          ...
          <div className="flex flex-col justify-between gap-5 pt-7 text-[10px] uppercase tracking-[0.18em] text-white/30 sm:flex-row">
            ...
            <div className="flex gap-5">
              {footerData?.social?.instagram && (
                <a href={footerData.social.instagram} target="_blank" rel="noopener noreferrer" className="hover:text-[#d7bd77] transition-colors">
                  Instagram
                </a>
              )}
              {footerData?.social?.linkedin && (
                <a href={footerData.social.linkedin} target="_blank" rel="noopener noreferrer" className="hover:text-[#d7bd77] transition-colors">
                  LinkedIn
                </a>
              )}
              {footerData?.social?.youtube && (
                <a href={footerData.social.youtube} target="_blank" rel="noopener noreferrer" className="hover:text-[#d7bd77] transition-colors">
                  YouTube
                </a>
              )}
              {footerData?.social?.facebook && (
                <a href={footerData.social.facebook} target="_blank" rel="noopener noreferrer" className="hover:text-[#d7bd77] transition-colors">
                  Facebook
                </a>
              )}
            </div>
